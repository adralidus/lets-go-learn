...
import { Bell, Plus, Trash2, Send, Users, Shield, GraduationCap } from 'lucide-react';
...
export function SystemNotifications() {
  ...
  const getTargetIcon = (targetRole?: string, isSystemWide?: boolean) => {
  ...
  const getTargetLabel = (notification: SystemNotification) => {
    ...
    if (notification.target_role) return notification.target_role.replace('_', ' ').toUpperCase();
    if (notification.target_user_id) return 'Specific User';
    return 'Unknown';
  };
